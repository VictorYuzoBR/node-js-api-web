...
function loadselect() {
  _axios.default.get(url + "perfil", {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $("#selecionaperfil").append($("<option></option>").attr("value", item.id).text(item.nome));
    });
  ...
  _loadUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _axios.default.get(url + 'user2/' + id, {}).then(function (response) {
...
function clear() {
  $("#id").val(""), $("#nome").val(""), $("#email").val(""), $("#password").val(""), $("#admin").prop("checked", false), refreshtable();
}
