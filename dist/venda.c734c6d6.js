...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/venda.js":[function(require,module,exports) {
"use strict";
...
function loadselect() {
  _axios.default.get(url + "users", {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $("#selecionausuario").append($("<option></option>").attr("value", item.id).text(item.name));
    });
  }).catch(function (error) {
    alert("error");
  });
  _axios.default.get(url + "produtos", {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $("#selecionaproduto").append($("<option></option>").attr("value", item.id).text(item.nome));
    });
  }).catch(function (error) {
    alert("error");
  });
...
function loadTable() {
  _axios.default.get(url + "venda", {}).then(function (response) {
    var table = new DataTable("#tabela_venda", {
      data: response.data,
      columns: [{
        data: "iduser.name"
      }, {
  ...
  _update = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.put(url + 'venda', {
            id: $("#id").val(),
            quantidade: $("#quantidade").val(),
            iduser: $("#selecionausuario option:selected").val(),
            idproduto: $("#selecionaproduto option:selected").val()
  ...
  _loadUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _axios.default.get(url + 'venda2/' + id, {}).then(function (response) {
...
function _deleteRecord() {
  _deleteRecord = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(id) {
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return _axios.default.delete(url + 'venda/' + id, {}).then(function (response) {
...
function clear() {
  $("#id").val(""), $("#quantidade").val(""), refreshtable();
}
...
function _insert() {
  _insert = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return _axios.default.post(url + 'venda', {
            quantidade: $("#quantidade").val(),
            iduser: $("#selecionausuario option:selected").val(),
            idproduto: $("#selecionaproduto option:selected").val()
          }).then(function (response) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/venda.js"], null)
//# sourceMappingURL=/venda.c734c6d6.js.map