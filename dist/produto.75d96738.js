...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/produto.js":[function(require,module,exports) {
"use strict";
...
function loadselect() {
  _axios.default.get(url + "categoria", {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $("#selecionacategoria").append($("<option></option>").attr("value", item.id).text(item.nome));
    });
  ...
  _update = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.put(url + 'produtos', {
            id: $("#id").val(),
            nome: $("#nome").val(),
  ...
  _loadUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _axios.default.get(url + 'produtos2/' + id, {}).then(function (response) {
  ...
  _deleteRecord = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(id) {
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return _axios.default.delete(url + 'produtos/' + id, {}).then(function (response) {
...
function clear() {
  $("#id").val(""), $("#nome").val(""), $("#fabricante").val(""), $("#validade").val(""), refreshtable();
}
  ...
  _insert = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return _axios.default.post(url + 'produtos', {
            nome: $("#nome").val(),
            fabricante: $("#fabricante").val(),
            validade: $("#validade").val(),
            categoria: $("#selecionacategoria option:selected").val()
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/produto.js"], null)
//# sourceMappingURL=/produto.75d96738.js.map